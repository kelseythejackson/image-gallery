## React Image Gallery
after you run `npm install`, you'll need to create a `config.js` file in the `src` folder and structure it like so:
```
const apiKey = '';
export default apiKey;
```
Once you add the API Key you got from Flickr you should be good to go.
